...
namespace radio
{
   ...
   */
  class SoundTochSSDPClient : public QObject
  {
    Q_OBJECT
     ...
     */
    SoundTochSSDPClient( QObject *parent = 0 );
     ...
     */
    void newDeviceEvent( const QString &usn,
     ...
     */
    void notifyReceived( QNetworkReply *datagram );
    // void notifyReceived( QHttpRequestHeader *datagram );

    private:
    bool running;

    SoundTouchUDPListener *udpListener;
  };
